...
{
    public class Joystick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler, IEndDragHandler, IJoystick
    {
        ...
        public void OnDrag(PointerEventData eventData)
        {
            ...
            if (length.magnitude > radialDistance)
            {
                ...
                OnJoystickDrag.Invoke(_knobInitialPos - (Vector2)tr.position);
            }
            else
            {
